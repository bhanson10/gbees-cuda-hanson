...
struct Measurement{
    ...
    float mean[DIM];        // measurement mean
    float cov[DIM*DIM];    // covariance matrix
    float covInv[DIM*DIM]; // covariance inverse matrix
    float T;                // period of continuous-time propagation before next measurement update
};
